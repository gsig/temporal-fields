...
class Something(data.Dataset):
    def __init__(self, root, split, labelpath, cachedir, transform=None, target_transform=None):
        ...
        self.cls2int = parse_something_labels('/nfs.yoda/gsigurds/somethingsomething/something-something-v2-labels.json')
        self.labels = parse_something_json(labelpath, self.cls2int)
        self.root = root
        self.testGAP = 50
