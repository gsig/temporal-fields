...
def main():
    ...
    if opt.evaluate:
        ...
        trainer.validate_video(valvideo_loader, model, criterion, -1, opt)
        return
    ...
    for epoch in range(opt.start_epoch, opt.epochs):
        ...
        scores = {'top1train':top1,'top5train':top5,'top1val':top1val,'top5val':top5val,'mAP':mAP,'videoprec1':prec1,'videoprec5':prec5}
